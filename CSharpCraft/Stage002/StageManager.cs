...
namespace Stage002
{
    ...
    public class StageManager : BaseManager
    {
        ...
        public override void Run()
        {
            ...
            PlaySoundMem(StClass.DAT.mp3_Ending, DX_PLAYTYPE_BACK);
            ...
            while (StClass.isRunning && StClass.isStayStage)
            {
                ...
                double realSecondsToday = new DateTime(1900, 1, 1, 0, 0, 0).TimeOfDay.TotalSeconds;
                double virtualSecondsToday = (realSecondsToday * 72) % 86400;

                // ==========================
                // 更新処理
                // ==========================

                UpdateBackgroundColor(TimeSpan.FromSeconds(virtualSecondsToday));
                ...
                if (CheckSoundMem(StClass.DAT.mp3_Ending) == FALSE)
                {
